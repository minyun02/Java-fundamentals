...
setLayout(null);
		...
		add(lbl3).setBounds(402, 561, 400, 27); //310
			lbl3.setFont(fnt);
		add(check4).setBounds(370,580, 50, 50);
			check4.setEnabled(false); //예약 변경/취소 규정을 눌러서 확인해야 활성화
		add(bookingConfirmLbl).setBounds(402,590, 420,27);
			bookingConfirmLbl.setFont(fnt);
			
		//buttons
		add(payBtn).setBounds(370, 630, 100, 35);
			payBtn.setFont(fnt);
		add(cancelBtn).setBounds(530, 630, 100, 35);
